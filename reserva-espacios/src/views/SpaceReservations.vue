        ...
        <div class="detalle">
          ...
          <div v-if="reservasDelDia.length > 0">
            ...
            <div v-for="r in reservasDelDia" :key="r.id" class="card">
              ...
              <p><strong>📞 Celular:</strong> {{ r.telefono }}</p>
...
// ✅ MISMA LÓGICA RESPONSIVE QUE YA TE FUNCIONA
...
// 🔥 CLAVE: mover por BLOQUES (no de 1 en 1)
...
onMounted(async () => {
  ...
  const res = await api.get(`/reservas-espacio/${espacioId}`);
